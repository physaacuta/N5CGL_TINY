...
#End Region
	...
	Public Sub New()
		...
		lstSharedMemory.Add(New SHMEM(TBL_HY_STATUS_NAME, Marshal.SizeOf(GetType(TBL_HY_STATUS))))
		lstSharedMemory.Add(New SHMEM(TBL_HY_POINT_NAME, Marshal.SizeOf(GetType(TBL_HY_POINT))))
        lstSharedMemory.Add(New SHMEM(TBL_HY_COILINF_NAME, Marshal.SizeOf(GetType(TBL_HY_COILINF))))
        lstSharedMemory.Add(New SHMEM(TBL_HY_COILRESULT_NAME, Marshal.SizeOf(GetType(TBL_HY_COILRESULT))))
        lstSharedMemory.Add(New SHMEM(TBL_HY_MAP_ROW_NAME, Marshal.SizeOf(GetType(TBL_HY_MAP_ROW))))
        lstSharedMemory.Add(New SHMEM(TBL_HY_DEFECTINF_NAME, Marshal.SizeOf(GetType(TBL_HY_DEFECTINF))))
        lstSharedMemory.Add(New SHMEM(TBL_HY_DEFLIST_NAME, Marshal.SizeOf(GetType(TBL_HY_DEFLIST))))
        lstSharedMemory.Add(New SHMEM(TBL_HY_MAE_INF_NAME, Marshal.SizeOf(GetType(TBL_HY_MAE_INF))))
        'lstSharedMemory.Add(New SHMEM(TBL_HY_CYCLE_INF_NAME, Marshal.SizeOf(GetType(TBL_HY_CYCLE_INF))))
        lstSharedMemory.Add(New SHMEM(TBL_HY_ALARM_NAME, Marshal.SizeOf(GetType(TBL_HY_ALARM))))
