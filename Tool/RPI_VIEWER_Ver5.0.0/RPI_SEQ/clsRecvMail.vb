...
Public Class clsRecvMail
    ...
    '/ 公開イベント
    '/ /////////////////////////////////////////////////////////////////////////////////
    Public Event tEv_RecvMail(ByVal nEvtNo As Integer, ByVal que As COMMON_QUE_STRMIX)	' メールスロットイベント (イベントNo, Que本体情報)
    ...
    Public Sub New(ByVal cont As Control)
        Try
            mcls_Mail = New tClass.tClass_MailSlot(RPISEQ_NAME, 300)
