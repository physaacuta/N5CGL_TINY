================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: DummyLED プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した DummyLED には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには DummyLED アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
DummyLED.h
   ...
   CDummyLEDApp アプリケーション クラスを宣言します。

DummyLED.cpp
   これは、アプリケーション クラス CDummyLEDApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\DummyLED.ico
   ...
   アイコンはメイン リソース ファイル DummyLED.rc に含まれていま
   す。
...
DummyLEDDlg.h, DummyLEDDlg.cpp - ダイアログ
   これらのファイルは CDummyLEDDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な DummyLED.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   DummyLED.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
