================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TO_CHKLONG プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TO_CHKLONG には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TO_CHKLONG アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TO_CHKLONG.h
   ...
   CTO_CHKLONGApp アプリケーション クラスを宣言します。

TO_CHKLONG.cpp
   これは、アプリケーション クラス CTO_CHKLONGApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TO_CHKLONG.ico
   ...
   アイコンはメイン リソース ファイル TO_CHKLONG.rc に含まれていま
   す。
...
TO_CHKLONGDlg.h, TO_CHKLONGDlg.cpp - ダイアログ
   これらのファイルは CTO_CHKLONGDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TO_CHKLONG.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TO_CHKLONG.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
