================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TO_MAEDAT プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TO_MAEDAT には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TO_MAEDAT アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TO_MAEDAT.h
   ...
   CTO_MAEDATApp アプリケーション クラスを宣言します。

TO_MAEDAT.cpp
   これは、アプリケーション クラス CTO_MAEDATApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TO_MAEDAT.ico
   ...
   アイコンはメイン リソース ファイル TO_MAEDAT.rc に含まれていま
   す。
...
TO_MAEDATDlg.h, TO_MAEDATDlg.cpp - ダイアログ
   これらのファイルは CTO_MAEDATDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TO_MAEDAT.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TO_MAEDAT.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
