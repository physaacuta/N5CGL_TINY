================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: HT_DEFECT プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した HT_DEFECT には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには HT_DEFECT アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
HT_DEFECT.h
   ...
   CHT_DEFECTApp アプリケーション クラスを宣言します。

HT_DEFECT.cpp
   これは、アプリケーション クラス CHT_DEFECTApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\HT_DEFECT.ico
   ...
   アイコンはメイン リソース ファイル HT_DEFECT.rc に含まれていま
   す。
...
HT_DEFECTDlg.h, HT_DEFECTDlg.cpp - ダイアログ
   これらのファイルは CHT_DEFECTDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な HT_DEFECT.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   HT_DEFECT.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
