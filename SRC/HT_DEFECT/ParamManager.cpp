...
{
/*/ △
	m_CommonMast.nImgSaveNum = 1;

	m_CommonMast.nImgSave[0] = 0;
	m_CommonMast.nImgSave[1] = 1;
	m_CommonMast.nImgSave[2] = 0;
	m_CommonMast.nImgSave[3] = 0;

	m_CommonMast.nImgCullX = 4;
	m_CommonMast.nImgCullY = 4;
	return true;
//*/
