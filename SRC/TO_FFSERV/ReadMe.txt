================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TO_FFSERV プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TO_FFSERV には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TO_FFSERV アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TO_FFSERV.h
   ...
   CTO_FFSERVApp アプリケーション クラスを宣言します。

TO_FFSERV.cpp
   これは、アプリケーション クラス CTO_FFSERVApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TO_FFSERV.ico
   ...
   アイコンはメイン リソース ファイル TO_FFSERV.rc に含まれていま
   す。
...
TO_FFSERVDlg.h, TO_FFSERVDlg.cpp - ダイアログ
   これらのファイルは CTO_FFSERVDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TO_FFSERV.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TO_FFSERV.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
