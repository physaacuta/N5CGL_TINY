================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TI_RPISAVE プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TI_RPISAVE には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TI_RPISAVE アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TI_RPISAVE.h
   ...
   CTI_RPISAVEApp アプリケーション クラスを宣言します。

TI_RPISAVE.cpp
   これは、アプリケーション クラス CTI_RPISAVEApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TI_RPISAVE.ico
   ...
   アイコンはメイン リソース ファイル TI_RPISAVE.rc に含まれていま
   す。
...
TI_RPISAVEDlg.h, TI_RPISAVEDlg.cpp - ダイアログ
   これらのファイルは CTI_RPISAVEDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TI_RPISAVE.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TI_RPISAVE.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
