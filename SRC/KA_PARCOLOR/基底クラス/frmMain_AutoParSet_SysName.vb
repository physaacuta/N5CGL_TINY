Public Class frmMain_AutoParSet_SysName

    Private Sub frmMain_AutoParSet_SysName_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
