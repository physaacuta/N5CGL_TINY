Public Class frmMain_ParSet_UplList_SysName

    Private Sub frmMain_ParSet_UplList_SysName_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
