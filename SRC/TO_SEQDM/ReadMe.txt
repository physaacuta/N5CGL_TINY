================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TO_SEQDM プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TO_SEQDM には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TO_SEQDM アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TO_SEQDM.h
   ...
   CTO_SEQDMApp アプリケーション クラスを宣言します。

TO_SEQDM.cpp
   これは、アプリケーション クラス CTO_SEQDMApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TO_SEQDM.ico
   ...
   アイコンはメイン リソース ファイル TO_SEQDM.rc に含まれていま
   す。
...
TO_SEQDMDlg.h, TO_SEQDMDlg.cpp - ダイアログ
   これらのファイルは CTO_SEQDMDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TO_SEQDM.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TO_SEQDM.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
