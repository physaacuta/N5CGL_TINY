================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: XX_CPPSMPEX プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した XX_CPPSMPEX には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには XX_CPPSMPEX アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
XX_CPPSMPEX.h
   ...
   CXX_CPPSMPEXApp アプリケーション クラスを宣言します。

XX_CPPSMPEX.cpp
   これは、アプリケーション クラス CXX_CPPSMPEXApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\XX_CPPSMPEX.ico
   ...
   アイコンはメイン リソース ファイル XX_CPPSMPEX.rc に含まれていま
   す。
...
XX_CPPSMPEXDlg.h, XX_CPPSMPEXDlg.cpp - ダイアログ
   これらのファイルは CXX_CPPSMPEXDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な XX_CPPSMPEX.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   XX_CPPSMPEX.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
