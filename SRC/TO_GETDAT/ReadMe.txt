================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TO_GETDAT プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TO_GETDAT には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TO_GETDAT アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TO_GETDAT.h
   ...
   CTO_GETDATApp アプリケーション クラスを宣言します。

TO_GETDAT.cpp
   これは、アプリケーション クラス CTO_GETDATApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TO_GETDAT.ico
   ...
   アイコンはメイン リソース ファイル TO_GETDAT.rc に含まれていま
   す。
...
TO_GETDATDlg.h, TO_GETDATDlg.cpp - ダイアログ
   これらのファイルは CTO_GETDATDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TO_GETDAT.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TO_GETDAT.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
