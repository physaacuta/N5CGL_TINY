================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TO_PROCON プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TO_PROCON には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TO_PROCON アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TO_PROCON.h
   ...
   CTO_PROCONApp アプリケーション クラスを宣言します。

TO_PROCON.cpp
   これは、アプリケーション クラス CTO_PROCONApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TO_PROCON.ico
   ...
   アイコンはメイン リソース ファイル TO_PROCON.rc に含まれていま
   す。
...
TO_PROCONDlg.h, TO_PROCONDlg.cpp - ダイアログ
   これらのファイルは CTO_PROCONDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TO_PROCON.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TO_PROCON.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
