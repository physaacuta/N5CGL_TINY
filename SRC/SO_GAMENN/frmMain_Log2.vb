...
Public Class frmMain_Log2
    ...
    Private m_lstChkPCName As New List(Of DataGridViewCheckButtonCell)      ' ＰＣ名チェックボックスコントロール リスト
    Private m_lstChkPCKind As New List(Of DataGridViewCheckButtonCell)      ' PCKINDチェックボックスコントロール リスト
    ...
    <System.ComponentModel.Browsable(True) _
     ...
     , System.ComponentModel.Description("LOG_MASTER の ログ区分 (イベント)")>
    ...
    <System.ComponentModel.Browsable(True) _
     ...
     , System.ComponentModel.Category("☆Log画面専用プロパティ") _
     , System.ComponentModel.Description("LOG_MASTER の ログ区分 (重故障)")>
    ...
    <System.ComponentModel.Browsable(True) _
     ...
     , System.ComponentModel.Category("☆Log画面専用プロパティ") _
     , System.ComponentModel.Description("LOG_MASTER の ログ区分 (軽故障)")>
    ...
    <System.ComponentModel.Browsable(True) _
     ...
     , System.ComponentModel.Category("☆Log画面専用プロパティ") _
     , System.ComponentModel.Description("LOG_MASTER の ログ区分 (コメント)")>
    ...
    <System.ComponentModel.Browsable(True) _
     ...
     , System.ComponentModel.Category("☆Log画面専用プロパティ") _
     , System.ComponentModel.Description("LOG_MASTER のテーブル名称")>
    ...
    <System.ComponentModel.Browsable(True) _
     ...
     , System.ComponentModel.Category("☆Log画面専用プロパティ") _
     , System.ComponentModel.Description("LOG_INF のテーブル名称")>
    ...
    <System.ComponentModel.Browsable(True) _
     ...
     , System.ComponentModel.Category("☆Log画面専用プロパティ") _
     , System.ComponentModel.Description("PC_INF のテーブル名称")>
    ...
    <System.ComponentModel.Browsable(True) _
     ...
     , System.ComponentModel.Category("☆Log画面専用プロパティ") _
     , System.ComponentModel.Description("DBセッション")>
    ...
    <System.ComponentModel.Browsable(True) _
     ...
     , System.ComponentModel.Category("☆Log画面専用プロパティ") _
     , System.ComponentModel.Description("登録日付 ON/OFF")>
    ...
    <System.ComponentModel.Browsable(True) _
     , System.ComponentModel.DefaultValue(False) _
     , System.ComponentModel.Category("☆Log画面専用プロパティ") _
     , System.ComponentModel.Description("コメント機能 ON/OFF (Load前に設定済みの事。実行中は、変更不可)")>
    ...
    ''' <remarks></remarks>
    Protected Friend Overridable Sub AddCheckBoxPCName(ByVal chk As DataGridViewCheckButtonCell, ByVal pcName As String)
    ...
    ''' <remarks></remarks>
    Protected Friend Overridable Sub AddCheckBoxPCKind(ByVal chk As DataGridViewCheckButtonCell, ByVal pcName As String)
        chk.Tag = pcName        ' Tagに文字列を追加
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Protected Friend Function GetLstCheckCount(ByVal lstChk As List(Of DataGridViewCheckButtonCell)) As Integer
        Dim iCnt As Integer = 0
        For ii As Integer = 0 To lstChk.Count - 1
            If lstChk.Item(ii).Checked Then iCnt += 1
        Next ii
    ...
    Protected Friend Overridable Sub dgvInitialize(ByVal dgv As DataGridView)
        With dgv
            ...
            .ColumnCount = CInt(IIf(m_bIsCommentOn, em_LogListColm.iend, em_LogListColm.iend - 2))
