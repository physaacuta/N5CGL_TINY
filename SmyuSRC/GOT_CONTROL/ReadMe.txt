================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: GOT_CONTROL プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した GOT_CONTROL には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには GOT_CONTROL アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
GOT_CONTROL.h
   ...
   CGOT_CONTROLApp アプリケーション クラスを宣言します。

GOT_CONTROL.cpp
   これは、アプリケーション クラス CGOT_CONTROLApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\GOT_CONTROL.ico
   ...
   アイコンはメイン リソース ファイル GOT_CONTROL.rc に含まれていま
   す。
...
GOT_CONTROLDlg.h, GOT_CONTROLDlg.cpp - ダイアログ
   これらのファイルは CGOT_CONTROLDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な GOT_CONTROL.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   GOT_CONTROL.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
