================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: TO_CAMERA プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した TO_CAMERA には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには TO_CAMERA アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
TO_CAMERA.h
   ...
   CTO_CAMERAApp アプリケーション クラスを宣言します。

TO_CAMERA.cpp
   これは、アプリケーション クラス CTO_CAMERAApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\TO_CAMERA.ico
   ...
   アイコンはメイン リソース ファイル TO_CAMERA.rc に含まれていま
   す。
...
TO_CAMERADlg.h, TO_CAMERADlg.cpp - ダイアログ
   これらのファイルは CTO_CAMERADlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な TO_CAMERA.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   TO_CAMERA.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
