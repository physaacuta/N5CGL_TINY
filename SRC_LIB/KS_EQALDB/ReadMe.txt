================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KS_EQALDB プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KS_EQALDB には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KS_EQALDB アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KS_EQALDB.h
   ...
   CKS_EQALDBApp アプリケーション クラスを宣言します。

KS_EQALDB.cpp
   これは、アプリケーション クラス CKS_EQALDBApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KS_EQALDB.ico
   ...
   アイコンはメイン リソース ファイル KS_EQALDB.rc に含まれていま
   す。
...
KS_EQALDBDlg.h, KS_EQALDBDlg.cpp - ダイアログ
   これらのファイルは CKS_EQALDBDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KS_EQALDB.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KS_EQALDB.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
