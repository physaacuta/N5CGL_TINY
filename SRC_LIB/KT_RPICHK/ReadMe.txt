================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KT_RPICHK プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KT_RPICHK には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KT_RPICHK アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KT_RPICHK.h
   ...
   CKT_RPICHKApp アプリケーション クラスを宣言します。

KT_RPICHK.cpp
   これは、アプリケーション クラス CKT_RPICHKApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KT_RPICHK.ico
   ...
   アイコンはメイン リソース ファイル KT_RPICHK.rc に含まれていま
   す。
...
KT_RPICHKDlg.h, KT_RPICHKDlg.cpp - ダイアログ
   これらのファイルは CKT_RPICHKDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KT_RPICHK.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KT_RPICHK.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
