================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KT_TEMPMT プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KT_TEMPMT には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KT_TEMPMT アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KT_TEMPMT.h
   ...
   CKT_TEMPMTApp アプリケーション クラスを宣言します。

KT_TEMPMT.cpp
   これは、アプリケーション クラス CKT_TEMPMTApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KT_TEMPMT.ico
   ...
   アイコンはメイン リソース ファイル KT_TEMPMT.rc に含まれていま
   す。
...
KT_TEMPMTDlg.h, KT_TEMPMTDlg.cpp - ダイアログ
   これらのファイルは CKT_TEMPMTDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KT_TEMPMT.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KT_TEMPMT.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
