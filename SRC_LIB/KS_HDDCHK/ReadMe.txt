================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KS_HDDCHK プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KS_HDDCHK には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KS_HDDCHK アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KS_HDDCHK.h
   ...
   CKS_HDDCHKApp アプリケーション クラスを宣言します。

KS_HDDCHK.cpp
   これは、アプリケーション クラス CKS_HDDCHKApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KS_HDDCHK.ico
   ...
   アイコンはメイン リソース ファイル KS_HDDCHK.rc に含まれていま
   す。
...
KS_HDDCHKDlg.h, KS_HDDCHKDlg.cpp - ダイアログ
   これらのファイルは CKS_HDDCHKDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KS_HDDCHK.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KS_HDDCHK.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
