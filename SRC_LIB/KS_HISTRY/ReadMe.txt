================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KS_HISTRY プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KS_HISTRY には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KS_HISTRY アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KS_HISTRY.h
   ...
   CKS_HISTRYApp アプリケーション クラスを宣言します。

KS_HISTRY.cpp
   これは、アプリケーション クラス CKS_HISTRYApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KS_HISTRY.ico
   ...
   アイコンはメイン リソース ファイル KS_HISTRY.rc に含まれていま
   す。
...
KS_HISTRYDlg.h, KS_HISTRYDlg.cpp - ダイアログ
   これらのファイルは CKS_HISTRYDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KS_HISTRY.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KS_HISTRY.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
