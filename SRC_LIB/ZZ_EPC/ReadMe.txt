================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: ZZ_EPC プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した ZZ_EPC には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには ZZ_EPC アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
ZZ_EPC.h
   ...
   CZZ_EPCApp アプリケーション クラスを宣言します。

ZZ_EPC.cpp
   これは、アプリケーション クラス CZZ_EPCApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\ZZ_EPC.ico
   ...
   アイコンはメイン リソース ファイル ZZ_EPC.rc に含まれていま
   す。
...
ZZ_EPCDlg.h, ZZ_EPCDlg.cpp - ダイアログ
   これらのファイルは CZZ_EPCDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な ZZ_EPC.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   ZZ_EPC.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
