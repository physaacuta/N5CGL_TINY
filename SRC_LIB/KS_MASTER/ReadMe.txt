================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KS_MASTER プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KS_MASTER には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KS_MASTER アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KS_MASTER.h
   ...
   CKS_MASTERApp アプリケーション クラスを宣言します。

KS_MASTER.cpp
   これは、アプリケーション クラス CKS_MASTERApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KS_MASTER.ico
   ...
   アイコンはメイン リソース ファイル KS_MASTER.rc に含まれていま
   す。
...
KS_MASTERDlg.h, KS_MASTERDlg.cpp - ダイアログ
   これらのファイルは CKS_MASTERDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KS_MASTER.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KS_MASTER.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
