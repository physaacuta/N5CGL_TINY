================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KT_LEDMGR プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KT_LEDMGR には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KT_LEDMGR アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KT_LEDMGR.h
   ...
   CKT_LEDMGRApp アプリケーション クラスを宣言します。

KT_LEDMGR.cpp
   これは、アプリケーション クラス CKT_LEDMGRApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KT_LEDMGR.ico
   ...
   アイコンはメイン リソース ファイル KT_LEDMGR.rc に含まれていま
   す。
...
KT_LEDMGRDlg.h, KT_LEDMGRDlg.cpp - ダイアログ
   これらのファイルは CKT_LEDMGRDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KT_LEDMGR.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KT_LEDMGR.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
