================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KT_CHILER プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KT_CHILER には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KT_CHILER アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KT_CHILER.h
   ...
   CKS_CHILERApp アプリケーション クラスを宣言します。

KT_CHILER.cpp
   これは、アプリケーション クラス CKS_CHILERApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KT_CHILER.ico
   ...
   アイコンはメイン リソース ファイル KT_CHILER.rc に含まれていま
   す。
...
KS_CHILERDlg.h, KS_CHILERDlg.cpp - ダイアログ
   これらのファイルは CKS_CHILERDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KT_CHILER.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KT_CHILER.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
