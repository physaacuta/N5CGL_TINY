========================================================================
    コンソール アプリケーション : KS_START_ODBC プロジェクトの概要
========================================================================

この KS_START_ODBC アプリケーションは、AppWizard によって作成されました。  

このファイルには、KS_START_ODBC アプリケーションを構成する各ファイルの
内容の概略が記述されています。


KS_START_ODBC.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    KS_START_ODBC.pch とプリコンパイル済み型ファイル StdAfx.obj を
    ビルドするために使用します。
