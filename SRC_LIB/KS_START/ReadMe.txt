================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KS_START プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KS_START には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KS_START アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KS_START.h
   ...
   CKS_STARTApp アプリケーション クラスを宣言します。

KS_START.cpp
   これは、アプリケーション クラス CKS_STARTApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KS_START.ico
   ...
   アイコンはメイン リソース ファイル KS_START.rc に含まれていま
   す。
...
KS_STARTDlg.h, KS_STARTDlg.cpp - ダイアログ
   これらのファイルは CKS_STARTDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KS_START.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KS_START.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
