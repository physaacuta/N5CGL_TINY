================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: KS_MAILTR プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した KS_MAILTR には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには KS_MAILTR アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
KS_MAILTR.h
   ...
   CKS_MAILTRApp アプリケーション クラスを宣言します。

KS_MAILTR.cpp
   これは、アプリケーション クラス CKS_MAILTRApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\KS_MAILTR.ico
   ...
   アイコンはメイン リソース ファイル KS_MAILTR.rc に含まれていま
   す。
...
KS_MAILTRDlg.h, KS_MAILTRDlg.cpp - ダイアログ
   これらのファイルは CKS_MAILTRDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な KS_MAILTR.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   KS_MAILTR.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
